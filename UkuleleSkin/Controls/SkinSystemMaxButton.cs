...
{
    public class SkinSystemMaxButton : SkinSystemButton
    {
        Window targetWindow;
        public SkinSystemMaxButton()
        {
            Click += delegate
            {
        ...
        public static readonly DependencyProperty IsMaxProperty =
            DependencyProperty.Register("IsMax", typeof(bool), typeof(SkinSystemMaxButton), new PropertyMetadata(false));
    }
}
