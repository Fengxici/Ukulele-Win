...
namespace UkuleleSkin
{
    public class SkinWindow : Window
    {
        ...
        public static readonly DependencyProperty SystemButtonColorProperty =
            DependencyProperty.Register("SystemButtonColor", typeof(Brush), typeof(SkinWindow), new PropertyMetadata(new SolidColorBrush(Color.FromArgb(0, 255, 255, 255))));
        ...
        public static readonly DependencyProperty SystemButtonSizeProperty =
            DependencyProperty.Register("SystemButtonSize", typeof(double), typeof(SkinWindow), new PropertyMetadata(30.0));
        /// <summary>
        /// 系统按钮前景色
        /// </summary>
        ...
        public static readonly DependencyProperty SystemButtonForegroundProperty =
            DependencyProperty.Register("SystemButtonForeground", typeof(Brush), typeof(SkinWindow), new PropertyMetadata(new SolidColorBrush(Color.FromRgb(88, 88, 88))));
        ...
        public static readonly DependencyProperty SystemButtonOverColorProperty =
            DependencyProperty.Register("SystemButtonOverColor", typeof(Brush), typeof(SkinWindow), new PropertyMetadata(new SolidColorBrush(Color.FromArgb(40, 255, 255, 255))));
        ...
        public static readonly DependencyProperty SystemButtonCloseOverColorProperty =
            DependencyProperty.Register("SystemButtonCloseOverColor", typeof(Brush), typeof(SkinWindow), new PropertyMetadata(new SolidColorBrush(Color.FromRgb(255, 0, 0))));
        ...
        public static readonly DependencyProperty CaptionHeightProperty =
            DependencyProperty.Register("CaptionHeight", typeof(double), typeof(SkinWindow), new PropertyMetadata(30.0));
        ...
        public static readonly DependencyProperty CaptionBackgroundProperty =
            DependencyProperty.Register("CaptionBackground", typeof(Brush), typeof(SkinWindow), new PropertyMetadata(default));
        ...
        public static readonly DependencyProperty TitleContentProperty =
            DependencyProperty.Register("TitleContent", typeof(UIElement), typeof(SkinWindow), new PropertyMetadata(default));
        ...
        public static readonly DependencyProperty FitSystemWindowProperty =
            DependencyProperty.Register("FitSystemWindow", typeof(bool), typeof(SkinWindow), new PropertyMetadata(default));
